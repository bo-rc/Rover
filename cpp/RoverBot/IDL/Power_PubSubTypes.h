...
#ifndef _POWER__PUBSUBTYPES_H_
#define _POWER__PUBSUBTYPES_H_
...
#error Generated Power_ is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type Power_ defined by the user in the IDL file.
 * @ingroup POWER_
 */
class Power_PubSubType : public eprosima::fastdds::dds::TopicDataType {
public:
    typedef Power_ type;

    eProsima_user_DllExport Power_PubSubType();

    eProsima_user_DllExport virtual ~Power_PubSubType();
