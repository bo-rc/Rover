...
#ifndef _ATTITUDE__H_
#define _ATTITUDE__H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Attitude__SOURCE)
#define Attitude__DllAPI __declspec( dllexport )
#else
#define Attitude__DllAPI __declspec( dllimport )
#endif // Attitude__SOURCE
#else
#define Attitude__DllAPI
#endif
#else
#define Attitude__DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure Attitude_ defined by the user in the IDL file.
 * @ingroup ATTITUDE_
 */
class Attitude_
{
public:
     ...
     */
    eProsima_user_DllExport Attitude_();
     ...
     * @param x Reference to the object Attitude_ that will be copied.
     */
    eProsima_user_DllExport Attitude_(const Attitude_ &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object Attitude_ that will be copied.
     */
    eProsima_user_DllExport Attitude_(Attitude_ &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object Attitude_ that will be copied.
     */
    eProsima_user_DllExport Attitude_& operator=(const Attitude_ &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object Attitude_ that will be copied.
     */
    eProsima_user_DllExport Attitude_& operator=(Attitude_ &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const Attitude_& data, size_t current_alignment = 0);
