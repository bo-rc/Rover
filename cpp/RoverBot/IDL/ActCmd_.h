...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(ActCmd__SOURCE)
#define ActCmd__DllAPI __declspec( dllexport )
#else
#define ActCmd__DllAPI __declspec( dllimport )
#endif // ActCmd__SOURCE
#else
#define ActCmd__DllAPI
#endif
#else
#define ActCmd__DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure ActCmd_ defined by the user in the IDL file.
 * @ingroup ACTCMD_
 */
class ActCmd_
{
public:
     ...
     */
    eProsima_user_DllExport ActCmd_();
     ...
     * @param x Reference to the object ActCmd_ that will be copied.
     */
    eProsima_user_DllExport ActCmd_(const ActCmd_ &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object ActCmd_ that will be copied.
     */
    eProsima_user_DllExport ActCmd_(ActCmd_ &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object ActCmd_ that will be copied.
     */
    eProsima_user_DllExport ActCmd_& operator=(const ActCmd_ &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object ActCmd_ that will be copied.
     */
    eProsima_user_DllExport ActCmd_& operator=(ActCmd_ &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const ActCmd_& data, size_t current_alignment = 0);
