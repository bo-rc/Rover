...
#ifndef _OPCMD__PUBSUBTYPES_H_
#define _OPCMD__PUBSUBTYPES_H_
...
#error Generated OpCmd_ is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type OpCmd_ defined by the user in the IDL file.
 * @ingroup OPCMD_
 */
class OpCmd_PubSubType : public eprosima::fastdds::dds::TopicDataType {
public:
    typedef OpCmd_ type;

    eProsima_user_DllExport OpCmd_PubSubType();

    eProsima_user_DllExport virtual ~OpCmd_PubSubType();
