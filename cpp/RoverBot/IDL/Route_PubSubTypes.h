...
#ifndef _ROUTE__PUBSUBTYPES_H_
#define _ROUTE__PUBSUBTYPES_H_
...
#error Generated Route_ is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type Route_ defined by the user in the IDL file.
 * @ingroup ROUTE_
 */
class Route_PubSubType : public eprosima::fastdds::dds::TopicDataType {
public:
    typedef Route_ type;

    eProsima_user_DllExport Route_PubSubType();

    eProsima_user_DllExport virtual ~Route_PubSubType();
